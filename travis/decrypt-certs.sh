...
openssl aes-256-cbc -k "$ENCRYPTION_SECRET" -in ./travis/profile/Taqtile_Travis_Test_Adhoc.mobileprovision.enc -d -a -out ./travis/profile/TravisCiIntegration.mobileprovision
